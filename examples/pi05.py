...
DEFAULT_CONFIG = Path(__file__).with_name("configs") / "pi05/2cam/fp16.toml"
...
def main() -> int:
    ...
    result = maybe_run_catalog('pi05', DEFAULT_CONFIG)
    ...
    policy = Pi05Policy.from_pretrained(
        ...
        optimized_profile=model_config.get("optimized_profile"),
